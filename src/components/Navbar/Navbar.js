...
const Navbar = (props) => {
  ...
  const menuItems = [
    ...
    {
      id: 5,
      menuTitle: "Join As Decision Maker",
      pageURL: "/signupDM",
    },
  ];
      ...
      <AppBar position="static" color="inherit">
        <Toolbar className={classes.toolbar} variant="dense">
          <div className={classes.brandContainer}>
            ...
            <span className={classes.fistIcon}>
          ...
          {isMobile ? (
            <>
                ...
                {user && (
                  <div className={classes.profile}>
                    <Avatar
                      ...
                      alt={user.resultData.name}
                      src={user.resultData.imageUrl}
                    >
                      {user.resultData.name.charAt(0)}
                    </Avatar>
                  </div>
                )}
                <MenuIcon />
              ...
              >
                ...
                {user ? (
                  <>
                    <MenuItem
                      style={{ background: "inherit", cursor: "default" }}
                    >
            ...
            <div className={classes.menuOptions}>
              <div className={classes.headerOptions}>
                <CustomButton
                  onClick={() => handleButtonClick("/start-a-petition")}
                >
                  Start a petition
                </CustomButton>
                ...
                <CustomButton onClick={() => handleButtonClick("/signupDM")}>
                  Join As Decision Maker
                </CustomButton>
              </div>
